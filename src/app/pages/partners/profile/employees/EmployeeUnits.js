...
import EmployeeUnitsTable from './EmployeeUnitsTable'

function EmployeeUnits() {
    ...
    <div className='card mb-10'>
      ...
      <div className='card-header border-0 pt-5 align-items-end'>
        <h5 className='card-title align-items-start flex-column'>
          <span className='mb-3 fw-bolder'>
            {intl.formatMessage({id: 'UNITS'})} ({propsData.employeeName})
          </span>
        </h5>
        <div className='card-toolbar'>
          <Link to={profilePath + '/employees'} className='btn btn-light btn-sm btn-flex fw-bold'>
      ...
      <div className='card-body py-3'>
        {!apiRespone || isLoaded ? (
          ...
          <EmployeeUnitsTable items={items} />
        )}
      </div>
      {/* begin::Body */}
