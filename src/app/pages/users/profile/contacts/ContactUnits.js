...
import ContactUnitsTable from './ContactUnitsTable'

function ContactUnits() {
      ...
      <div className='card-header border-0 pt-5 align-items-end'>
        <h5 className='card-title align-items-start flex-column'>
          <span className='mb-3 fw-bolder'>
            {intl.formatMessage({id: 'UNITS'})} ({propsData.contactName})
          </span>
        </h5>
        <div className='card-toolbar'>
          <Link to={profilePath + '/contacts'} className='btn btn-light btn-sm btn-flex fw-bold'>
