...
import {getActivities, getActivityCategories, getAgeGroups} from '../../_requests'
...
export function FilterDropdown(porop) {
  ...
  const [ageGroupChoice, setAgeGroupChoice] = useState(DefOptions[0])
  ...
  const ageGroupsOptionsHandler = () => {
    const newAgeGroupsOptions = [...DefOptions, ...ageGroupsOptions]
    setAgeGroupsOptions(newAgeGroupsOptions)
  }
  ...
  const resetHandler = () => {
    ...
    setActivityChoice(DefOptions[0])
    setAgeGroupChoice(DefOptions[0])
        ...
        <div className='mb-3'>
          ...
          <div>
            <Select
              ...
              onChange={(choice) => setAgeGroupChoice(choice)}
            />
          </div>
        </div>
        <div className='mb-3'>
