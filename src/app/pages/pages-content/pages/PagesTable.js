            ...
            {items.map((e) => {
              return (
                <tr key={e.id}>
                  ...
                  <td>{e.title || '---'}</td>
                  <td className='text-center'>{e.target || '---'}</td>
                  <td className='text-center'>
                    <span
                      className={`badge badge-light-${e.status.toLowerCase() === 'publish' ? 'primary' : 'danger'
                        }`}
                    >
                      {e.status}
                    </span>
                  ...
                  <td className='text-center'>
                    <Link
                      to={`/pages-content/pages/translations/${e.id}`}
                    ...
                    <Link
                      to={`/pages-content/pages/view/${e.id}`}
                      className='btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-3'
                    >
                      <KTIcon iconName='eye' className='fs-3' />
                    </Link>
                    <Link
                      to={`/pages-content/pages/edit/${e.id}`}
                      className='btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-3'
                    >
