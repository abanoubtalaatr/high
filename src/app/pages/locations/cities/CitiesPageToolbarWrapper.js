...
function CitiesPageToolbarWrapper(props) {
  ...
  return (
    <div id='kt_app_toolbar' className='app-toolbar py-3 py-lg-6'>
      <div id='kt_app_toolbar_container' className='p-0 d-flex flex-stack container-fluid'>
        ...
        {/* modal */}
        <CreateModal show={showCreateModal} onHide={closeCreateModal} onComplete={completeHandler} />
        {/* end modal */}
      </div>
    </div>
  )
...
export default CitiesPageToolbarWrapper
