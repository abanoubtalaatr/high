...
import {updateLanguage} from '../_requests'
import {Modal} from 'react-bootstrap'
import Select from 'react-select'

function EditLanguageeModal(props) {
  ...
  const [imageBg, setImageBg] = useState(itemDetails.image)
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, {setStatus, resetForm, setFieldValue}) => {
      ...
      try {
        await updateLanguage(formData, itemDetails.id).then((res) => {
          resetForm()
...
export default EditLanguageeModal
