...
function TransactionViewToolbarWrapper() {
  const { iso } = useParams()
  return (
    <div id='kt_app_toolbar' className='app-toolbar py-3 py-lg-6'>
      <div id='kt_app_toolbar_container' className='p-0 d-flex flex-stack container-fluid'>
        ...
        <div className='d-flex gap-5'>
          <Link to={`/wallet/${iso}/transactions`} className='btn btn-light btn-sm btn-flex fw-bold'>
...
export default TransactionViewToolbarWrapper
