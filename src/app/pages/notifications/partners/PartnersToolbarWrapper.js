...
function PartnersToolbarWrapper() {
  return (
    <div id='kt_app_toolbar' className='app-toolbar py-3 py-lg-6'>
      <div id='kt_app_toolbar_container' className='p-0 d-flex flex-stack container-fluid'>
        <PageTitleWrapper />
        <Link to='/notifications/partners/new' className='btn btn-primary btn-sm btn-flex fw-bold'>
...
export default PartnersToolbarWrapper
