...
import {getUser, getUsersNotifications} from '../_requests'
import ItemsTable from './UsersItemsTable'
import Select from 'react-select'
import Pagination from '../../../components/pagination/Pagination'
import Spinner from '../../../components/spinner/Spinner'
import UsersItemsTable from './UsersItemsTable'

function UsersTableWrapper(props) {
      ...
      <div className='card'>
        ...
        <div className='card-body py-3'>
          {isLoaded ? (
            ...
            <UsersItemsTable items={items} onComplete={completeHandler} />
          )}
        </div>
