      ...
      <table className='table table-row-dashed table-row-gray-300 align-middle gy-4'>
        ...
        <thead>
          <tr className='bg-light'>
            ...
            <th className='min-w-100px text-center fs-6'>company</th>
          ...
          {items.map((e) => {
            return (
              <tr key={e.id}>
                ...
                <td className='text-center fs-6'>{e.company_name || '---'}</td>
                ...
                <td className='text-center fs-6'>
                  <div className='d-flex justify-content-start flex-column'>
                    <span className='fs-6'>{e.activity_category_name || '---'}</span>
                    <span className='fs-6'>{e.activity_name || '---'}</span>
                  </div>
                </td>
