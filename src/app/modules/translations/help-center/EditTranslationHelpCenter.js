...
function EditTranslationHelpCenter() {
    ...
    onSubmit: async (values, { setStatus, resetForm, setFieldValue }) => {
      ...
      translateItemDetails.translations.map((tr) => {
        if (tr.column_name === 'title') {
          ...
          try {
            updateTranslation(vals, 'help-center', itemDetails.id).then((res) => {
              resetForm()
    ...
    <>
      <div id='kt_app_toolbar' className='app-toolbar py-3 py-lg-6'>
        <div id='kt_app_toolbar_container' className='p-0 d-flex flex-stack container-fluid'>
          <PageTitleWrapper />
          <Link to={`../help-center/translations/${itemDetails.id}`}
            state={{ ...itemDetails }}
          ...
          <div className='card-body py-3 pt-5'>
            ...
            <div className='card-footer ps-0 pe-0'>
              <div className='d-flex justify-content-between'>
                <Link to={`../help-center/translations/${itemDetails.id}`} className='btn btn-light'
                  state={{ ...itemDetails }}>
...
export default EditTranslationHelpCenter
